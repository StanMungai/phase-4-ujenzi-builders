...
scrapper = Contractor.create(name: "Scrapper General Building Contractors", contact: 2547000000, overview: "Registered in Kenya as a limited liability company dealing in civil and water works")
don = Contractor.create(name: "Don constructors", contact: 2547111111, overview: "Offers full spectrum of building construction and we are recognized as a specialist in utilizing current technology in the markets")
harris = Contractor.create(name: "The Harris Solutions", contact: 2547222222, overview: "A strong foundation for diversified General Construction Work, Renovations of Buildings, and Supplies of Construction materials")
